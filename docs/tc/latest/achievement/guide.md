...
成就系統使用 JSON 設定檔定義成就，預設路徑為 `res://addons/konado_achievement/data/default_achievements.json`，也可以在 `KonadoAchievements` 中設定其他路徑。
...
在 `KonadoAchievements` 中，您可以透過以下屬性進行設定：
