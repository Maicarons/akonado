...
In the autoloaded `KonadoWebTool` node, you can configure the following properties:

| Property | Type | Default | Description |
|------|------|--------|------|
| `developer_shortcuts_enabled` | bool | true | Whether to allow Web developer tool shortcuts |
...
```gdscript
KonadoWebTool.refresh_shortcuts()
```
