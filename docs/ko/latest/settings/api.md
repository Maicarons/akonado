...
- **items: Array[KonadoSettingItem]**: 카테고리에 포함된 설정 항목 배열.
...
설정 값은 Godot의 `ConfigFile` 형식으로 `user://konado_settings.cfg` 파일에 자동 저장됩니다.
...
1. **새 설정 타입 추가**:
   - `KonadoSettingItem.Type`에 새 열거형 값을 추가합니다.
