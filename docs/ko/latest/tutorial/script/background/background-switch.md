...
## 기능 설명
게임 장면의 배경 씬을 전환하며, 전환 효과를 지원합니다.

배경 리소스는 씬 목록에서 설정합니다. 만드는 방법은 [씬 기반 리소스](../../core/scene-assets.md)를 참고하세요.

## 문법 구조
```text
background <배경 리소스 이름> [효과 유형]
```

## 매개변수 설명
| 매개변수 | 필수 | 예시 값 | 설명 |
|------|------|--------|------|
| 배경 리소스 이름 | 예 | `morning_forest` | 배경 목록에 설정된 배경 씬 이름 |
