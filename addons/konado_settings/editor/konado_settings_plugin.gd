...
const AUTOLOAD_NAME := "KonadoSettings"
const AUTOLOAD_PATH := "res://addons/konado_settings/runtime/konado_settings_manager.gd"
...
func _ensure_autoload() -> void:
	...
	if configured_path != AUTOLOAD_PATH:
		push_error(
			(
				"Cannot enable Konado Settings: autoload '%s' already points to '%s'."
